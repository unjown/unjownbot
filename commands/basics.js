...
const donate = new Discord.MessageEmbed()
  .setTitle('DONATE')
  .setColor('#ffB35c')
	.setDescription('donate on [Paypal](https://www.paypal.me/alexserver) or [Patreon](https://www.patreon.com/alexservers) or [buymeacoffee](https://www.buymeacoffee.com/alexservers)')
	.addFields(
